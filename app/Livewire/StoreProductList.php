...
class StoreProductList extends Component
{
    ...
    {
        // Filas de categorías drill-down
        $categoryRows = [];
        ...
        // IDs a filtrar (última categoría seleccionada + todos sus descendientes)
        $filterIds = [];
        if (!empty($this->path)) {
        ...
        return view('livewire.store-product-list', compact('products', 'categoryRows'));
    }
