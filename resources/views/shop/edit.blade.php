            ...
            <form action="{{ route('publish.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="field-group">
                    ...
                    <input id="nombre" type="text" name="nombre" value="{{ old('nombre', $product->nombre) }}"
                           @class(['w-full rounded-xl border bg-gray-50 dark:bg-gray-700 px-4 py-2.5 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-400 transition', 'border-red-500' => $errors->has('nombre'), 'border-gray-300 dark:border-gray-600' => !$errors->has('nombre')])>
                    @error('nombre')
                ...
                <div class="field-group">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="4"
                              @class(['w-full rounded-xl border bg-gray-50 dark:bg-gray-700 px-4 py-2.5 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-400 transition', 'border-red-500' => $errors->has('descripcion'), 'border-gray-300 dark:border-gray-600' => !$errors->has('descripcion')])>{{ old('descripcion', $product->descripcion) }}</textarea>
                    @error('descripcion')
                        <p class="field-error text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="field-group">
                        ...
                        <div class="relative">
                            <input id="precio" type="number" step="0.01" min="0" name="precio" value="{{ old('precio', $product->precio) }}"
                                   @class(['w-full rounded-xl border bg-gray-50 dark:bg-gray-700 px-4 py-2.5 pr-8 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-400 transition', 'border-red-500' => $errors->has('precio'), 'border-gray-300 dark:border-gray-600' => !$errors->has('precio')])>
                    ...
                    <div class="field-group">
                        ...
                        <select id="category_id" name="category_id"
                                @class(['w-full rounded-xl border bg-gray-50 dark:bg-gray-700 px-4 py-2.5 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-gold-400 transition', 'border-red-500' => $errors->has('category_id'), 'border-gray-300 dark:border-gray-600' => !$errors->has('category_id')])>
