<nav id="sidebar" class="bg-white dark:bg-gray-900 shadow-xl flex flex-col p-4 sticky top-0 h-screen transition-colors duration-300" style="width: 300px;">
    ...
    <div class="px-1 mb-3">
        <button
            onclick="toggleTheme()"
            id="theme-toggle-btn"
            class="w-full flex items-center justify-between px-4 py-3 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 transition-all group"
        >
    ...
    <div class="user-footer mt-2">
        @auth
            <a href="{{ route('profile.edit') }}" class="block p-4 rounded-2xl mb-4 border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all" wire:navigate.hover>
                <div class="flex items-center gap-3">
            ...
            <form action="{{ route('logout') }}" method="post">
                @csrf
                <button id="cerrarsesion" type="submit" class="flex w-full items-center justify-center gap-2 text-red-600 border border-red-200 dark:border-red-900 rounded-full py-2.5 font-bold text-sm hover:bg-red-50 dark:hover:bg-red-950 transition-all">
