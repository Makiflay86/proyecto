                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" rows="4"
                                  class="w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg shadow-sm focus:border-gold-500 focus:ring-gold-500 transition">{{ old('descripcion') }}</textarea>
                    </div>
