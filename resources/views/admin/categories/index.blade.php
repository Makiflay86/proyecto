        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($categories->isEmpty())
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-12 text-center transition-colors duration-300">
                    ...
                    <a href="{{ route('categories.create') }}"
                       class="mt-4 inline-block bg-gold-600 text-white px-6 py-2 rounded-full hover:bg-gold-700 transition duration-200 text-sm"
                       wire:navigate.hover>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-xl dark:hover:shadow-gold-900/30 transition-all duration-300">
                            <div class="p-6 flex flex-col gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @else
                                        <div class="bg-gold-100 dark:bg-gold-900/30 rounded-xl p-3 shrink-0">
                                ...
                                <div class="flex justify-end">
                                    <a href="{{ route('categories.show', $category) }}"
                                       class="text-gold-600 dark:text-gold-400 hover:text-gold-700 dark:hover:text-gold-300 font-medium text-sm"
                                       wire:navigate.hover>
                                        Ver detalle →
                                    </a>
                                </div>
