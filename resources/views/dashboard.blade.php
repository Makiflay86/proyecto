<x-app-layout>
    ...
    {{-- Chart.js CDN cargado en el <head> para que esté disponible en dashboard.js --}}
    @push('head-scripts')
        <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.4/dist/chart.umd.min.js"></script>
    @endpush

    {{-- Datos de PHP pasados al JS a través de data-attributes (sin código inline) --}}
    ...
    <div class="py-8 bg-gray-100 dark:bg-gray-900 min-h-screen transition-colors duration-300">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 shadow-sm sm:rounded-xl p-6 transition-colors duration-300">
