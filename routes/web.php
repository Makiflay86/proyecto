...
Route::get('/publicar',  [PublishController::class, 'create'])->middleware(['auth', 'verified'])->name('publish.create');
Route::post('/publicar', [PublishController::class, 'store'])->middleware(['auth', 'verified'])->name('publish.store');
Route::get('/producto/{product}/editar',       [PublishController::class, 'edit'])->middleware('auth')->name('publish.edit');
Route::put('/producto/{product}',              [PublishController::class, 'update'])->middleware('auth')->name('publish.update');
Route::delete('/producto/{product}',           [PublishController::class, 'destroy'])->middleware('auth')->name('publish.destroy');
